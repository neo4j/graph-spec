...
class NodeJsTest : JsMappingTest<Node, NodeJs>() {
    ...
    override fun createClass() = Node(
        labels = Labels("label"),
        properties = mutableMapOf("prop" to Property(StringType, name = "propertyName")),
    ...
    override fun verifyJsObject(jsObject: NodeJs) {
        ...
        assertJsEquals(propertyJs(neo4jTypeJs("STRING"), id = "prop", name = "propertyName"), jsObject.properties["prop"])
